...
import org.killbill.billing.plugin.usage.api.UsagePluginApiImpl;
...
public class UsageActivator extends KillbillActivatorBase {
  ...
  public static final String PLUGIN_NAME = "usage-plugin";
  ...
  public void start(final BundleContext context) throws Exception {
    ...
    final UsagePluginApi paymentPluginApi =
        new UsagePluginApiImpl(
            usageConfigurationHandler, killbillAPI, configProperties, clock.getClock());
    ...
    //        new PluginAppBuilder(PLUGIN_NAME, killbillAPI, dataSource, super.clock,
    // configProperties)
    //            .withRouteClass(UsageHealthcheckServlet.class)
