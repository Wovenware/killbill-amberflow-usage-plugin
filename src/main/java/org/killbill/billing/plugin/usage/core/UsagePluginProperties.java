...
public abstract class UsagePluginProperties {

  public enum PaymentMethodType {
    CARD
  }

  private static final Logger logger = LoggerFactory.getLogger(UsagePluginProperties.class);
  ...
  public static String asString(final Map<?, ?> additionalData) {
  ...
  public static String asString(final Object additionalData) {
