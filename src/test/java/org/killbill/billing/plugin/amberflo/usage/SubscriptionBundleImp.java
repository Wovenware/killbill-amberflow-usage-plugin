...
public class SubscriptionBundleImp implements SubscriptionBundle {
  ...
  protected SubscriptionBundleImp(final List<Subscription> subscriptions) {
  ...
  public boolean equals(final Object o) {
    ...
    if ((this.originalCreatedDate != null)
        ? (0 != this.originalCreatedDate.compareTo(that.originalCreatedDate))
        : (that.originalCreatedDate != null)) {
      return false;
    }
